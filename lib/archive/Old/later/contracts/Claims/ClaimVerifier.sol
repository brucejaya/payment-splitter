...
contract ClaimVerifier {
	...
	event ClaimValid(ClaimRegistry _identity, uint256 claimType);
	event ClaimInvalid(ClaimRegistry _identity, uint256 claimType);

	ClaimRegistry public trustedClaimHolder;

	function setClaimHolder(address _trustedClaimRegistry) public {
		trustedClaimHolder = ClaimRegistry(_trustedClaimRegistry);
	}

	function checkClaim(
		ClaimRegistry _identity, 
		uint256 claimType
	)
		public
	...
	function getRecoveredAddress(bytes32 sig, bytes32 dataHash)
		public
		view
